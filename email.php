...
<div class="content-wrapper" style="padding-bottom: 20px;">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="email-form-container" style="padding-bottom: 50px;">
                <!-- Container baru dengan padding -->
                <form action="" method="post">
                    <div class="mb-3">
                        <label for="email penerima" class="form-label">Email Penerima</label>
                        <input type="text" class="form-control" id="email penerima" name="email penerima"
